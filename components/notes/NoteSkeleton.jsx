        ...
        {skeletons.map(index => (
          <motion.div
            ...
            className={`rounded-lg p-4 w-full max-w-full sm:max-w-[450px] h-[130px] animate-pulse ${
              index % 3 === 0 ? 'bg-red-200' : index % 3 === 1 ? 'bg-orange-200' : 'bg-teal-200'
            } relative mb-4`}
            variants={itemVariants}
          >
            <div className="flex h-full w-full">
              <div
                className={`w-5 h-5 rounded-md mr-3 ${
                  index % 3 === 0 ? 'bg-red-300' : index % 3 === 1 ? 'bg-orange-300' : 'bg-teal-300'
                }`}
              ></div>
              ...
              <div className="flex flex-col flex-1">
                <div className="flex items-center justify-between gap-3 sm:gap-12 mb-3 px-4">
                  <div
                    className={`h-5 rounded w-24 sm:w-32 ${
                      index % 3 === 0
                        ? 'bg-red-300'
                        : index % 3 === 1
                          ? 'bg-orange-300'
                  ...
                  ></div>
                  <div
                    className={`h-5 rounded w-16 sm:w-20 ${
                      index % 3 === 0
                        ? 'bg-red-300'
                        : index % 3 === 1
                          ? 'bg-orange-300'
